...
public interface QuizDao extends JpaRepository<Quiz, Integer> {
	...
	@Transactional	
	@Modifying
	@Query (value = "update quiz  set name = :name , description = :description , start_date = :startDate , end_date = :endDate , is_published = :published where id = :id  " ,nativeQuery = true)
